...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{asset('css/frontend_css/material-kit.css?v=2.0.5')}}" rel="stylesheet" />
...
{{--   <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script> --}}
  ...
  <script src="{{asset('js/frontend_js/material-kit.js?v=2.0.5')}}" type="text/javascript"></script>
